...
const HomePage = () => {
  ...
  const handleLogout = () => {
    ...
    setCurrentUser(null);
    setAuthToken(null); // => Trigger lại useEffect
                      ...
                      >
                        ...
                        <Carousel.Item>
                          <div
                            className="banner-slide"
                            style={{
                              backgroundImage: `url('https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRuiFGY42tBf1GQSsfJnpiYyQeWV8gV7L4e5TUTa7dzw91UoPxZ_Izr-W4DI_vcxnlDRsdc0a9utFslno3tcQ8mvpd07AVh11nAOepn0zLp8o-z-6DtDuXLLZ0vSK0wyVRpZ_n9_4rcYns&usqp=CAc')`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                              backgroundRepeat: "no-repeat",
                              width: "100%",
