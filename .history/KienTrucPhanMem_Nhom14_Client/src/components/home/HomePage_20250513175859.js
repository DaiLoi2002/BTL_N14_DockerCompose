...
const HomePage = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      if (!token || token === "null" || !authRef.current) {
    ...
    // Chỉ kích hoạt khi `isAuthenticated` là true
    if (isAuthenticated) {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        setCategories(data.data); // Lưu dữ liệu danh mục vào state
        setLoading(false); // Đánh dấu là xong việc tải dữ liệu
      } catch (err) {
  ...
  useEffect(() => {
    console.log("currentUser đã thay đổi:", currentUser);
  }, [currentUser]);
  ...
  const handleLogout = () => {
    ...
    setCurrentUser(null);
    setAuthToken(null);
    setIsAuthenticated(false); // Đã đăng xuất
  ...
  const handleCategoryHover = (category) => {
    ...
    if (!category.subcategories) {
      // This is where you'd trigger fetching subcategories from the server
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const searchResults = await axios.get(
        `/v1/products/search?query=${searchQuery}`
      );
                ...
                {Array.isArray(categories) && categories.length > 0 ? (
                  categories.map((category) => (
                    <div
                      ...
                      onMouseEnter={() => handleCategoryHover(category)} // Hover vào category để load subcategories
                      onMouseLeave={() => setActiveCategory(null)} // Khi rời khỏi category sẽ xóa activeCategory
                    >
                          ...
                          category.subcategories.length > 0 ? (
                            category.subcategories.map((sub) => (
                              <div
                                ...
                                onClick={() => handleSubcategoryClick(sub)} // Xử lý khi click vào subcategory
                              >
                                {sub.name}
                              </div>
                            ))
                  ...
                  <div className="p-3 text-center">Không có danh mục nào</div>
                )}
              </div>
            )}
          </div>
                      ...
                      >
                        <Carousel.Item>
                          <div
                            ...
                            style={{
                              backgroundImage: `url('https://giayinanh.net/image/catalog/Gi%E1%BA%A5y%20in%20v%C4%83n%20ph%C3%B2ng/Danh%20m%E1%BB%A5c%20gi%E1%BA%A5y%20in%20v%C4%83n%20ph%C3%B2ng/giay-in-van-phong-1.jpg')`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                              backgroundRepeat: "no-repeat",
                              width: "100%",
                              height: "350px", // hoặc bạn chỉnh chiều cao tùy ý
                            }}
                          >
                            <div className="banner-content">
                              ...
                              <div className="right-content">
                                <div className="product-image-placeholder">
                                  <img
                                    src="https://giayinanh.net/image/catalog/Gi%E1%BA%A5y%20in%20v%C4%83n%20ph%C3%B2ng/Danh%20m%E1%BB%A5c%20gi%E1%BA%A5y%20in%20v%C4%83n%20ph%C3%B2ng/giay-in-van-phong-1.jpg"
                                    alt="Giấy In Văn Phòng"
                                    style={{
                                      width: "200%",
                                      height: "auto",
                                      maxHeight: "200px",
                        ...
                        <Carousel.Item>
                          <div
                            className="banner-slide"
                            style={{
                              backgroundImage: `url('https://www.thanhthanh.co/cdn/shop/products/VBITL049H_960x780.png?v=1459239308')`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                              backgroundRepeat: "no-repeat",
                              width: "100%",
                              height: "100%", // hoặc bạn chỉnh chiều cao tùy ý
                            }}
                          >
                            <div className="banner-content">
                              <div className="left-content">
                        ...
                        <Carousel.Item>
                          <div
                            className="banner-slide"
                            style={{
                              backgroundImage: `url('https://vinhthinhpaper.vn/wp-content/uploads/2022/02/1-6-scaled.jpg')`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                              backgroundRepeat: "no-repeat",
                              width: "100%",
